...
if __name__ == '__main__':
	...
	array = [1,55,6,65,23,57,123,-1,-5,246,-2,242,100,4,423,2,564,9,0,10,8765,3,43,64]
	print(array)
	print("Max heap:")
	max_heap_sort(array)
	print(array)
	array = [1,5,65,3,23,246,57,123,-1,8765,-5,-2,242,100,4,423,2,564,9,0,55,10,43,64]
	print("Min heap:")
	min_heap_sort(array)
	print(array)
	print("Max Heap Time:", timeit.timeit('max_heap_sort(array)', setup="from __main__ import max_heap_sort, array",number=10000))
	print("Min Heap Time:", timeit.timeit('min_heap_sort(array)', setup="from __main__ import min_heap_sort, array",number=10000))